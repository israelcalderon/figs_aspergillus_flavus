...
\subfloat[\centering]{\includegraphics[width=6.0cm]{images/sample_figs_tray.png}}
\hspace{1mm}
\subfloat[\centering]{\includegraphics[width=6.0cm]{images/sample_figs_masks.png}}\\
\end{adjustwidth}
%} % If the paper is ``preprints'', please uncomment this parenthesis.
...
\centering
%} % If the paper is ``preprints'', please uncomment this parenthesis.
\subfloat[\centering]{\includegraphics[width=13.0cm]{images/spectral_signature_mean_reflectance.png}}\\
\subfloat[\centering]{\includegraphics[width=13.0cm]{images/spectral_signature_mean_standard_deviation.png}}
%\hfill
%\isPreprints{}{% This command is only used for ``preprints''.
\end{adjustwidth}
%} % If the paper is ``preprints'', please uncomment this parenthesis.
...
\centering
\subfloat[\centering]{\includegraphics[width=7.2cm]{images/mean_convergence_3b.png}} 
%\hfill
\subfloat[\centering]{\includegraphics[width=7.2cm]{images/mean_convergence_5b.png}}\\
\subfloat[\centering]{\includegraphics[width=7.2cm]{images/mean_convergence_6b.png}}
\hfill
%\end{adjustwidth}
