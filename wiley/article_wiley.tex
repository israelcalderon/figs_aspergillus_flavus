...
\corres{Israel Calderón Aguilar (\email{al2243804651@azc.uam.mx})}
...
\begin{figure}[!ht]
\centering
\subfloat[]{\includegraphics[width=3.5cm]{sample_figs_tray.png}}
\hspace{1mm}
\subfloat[]{\includegraphics[width=3.5cm]{sample_figs_masks.png}}
...
\begin{table}[!ht]
    ...
    \begin{tabular}{ccccc}
        \toprule
        \textbf{Generations} & \textbf{Population} & \textbf{Selection} & \textbf{Crossover} & \textbf{Mutation rate}\\
        \midrule
...
\begin{table}[!ht]
    ...
    \begin{tabular}{lll}
        \toprule
        \textbf{Parameter} & \textbf{Fast Evaluator} & \textbf{Exhaustive Evaluator} \\
        \midrule
        Kernel & RBF & RBF \\
...
\begin{figure}[!ht]
\centering
\subfloat[]{\includegraphics[width=0.5\textwidth]{spectral_signature_mean_reflectance.png}}\\
\subfloat[]{\includegraphics[width=0.5\textwidth]{spectral_signature_mean_standard_deviation.png}}
...
\begin{table}[!ht]
    ...
    \begin{tabular}{cccc}
        \toprule
        \textbf{Individual size} & \textbf{Mean ($\mu$)} & \textbf{Combined features ($\mu + \sigma$)} & \textbf{Improvement (\%)} \\
        \midrule
...
\begin{figure}[!ht]
    \centering
    \subfloat[]{\includegraphics[width=0.43\textwidth]{mean_convergence_3b.png}} \\ % Added line break
    \subfloat[]{\includegraphics[width=0.43\textwidth]{mean_convergence_5b.png}} \\ % Added line break
    \subfloat[]{\includegraphics[width=0.43\textwidth]{mean_convergence_6b.png}}
...
Figure \ref{fig:7} illustrates the mean reflectance spectra for healthy (green) and infected (red) figs, with the vertical blue dashed lines representing the bands of the best individuals selected by the GA across the 30 execution runs for $K\in\{3, 5, 6\}$.   
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.5\textwidth]{spectral_signature_selected_bands_ga.png}
...
\textbf{Israel Calderón Aguilar:} Conceptualization, Methodology, Software, Formal Analysis, Visualization, Writing – Original Draft. \textbf{Juan Villegas Cortez:} Supervision, Validation, Writing – Review \& Editing. \textbf{Josefa Díaz Álvarez:} Supervision, Validation, Writing – Review \& Editing. \textbf{Román Anselmo Mora Gutiérrez:} Supervision, Validation. \textbf{Francisco Fernandez De Vega:} Supervision, Validation. \textbf{Francisco Chávez de la O:} Supervision, Validation. \textbf{Arturo Zúñiga López:} Supervision, Validation.
