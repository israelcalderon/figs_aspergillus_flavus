...
\begin{figure*}[!ht]
\centering
\subfloat[]{\includegraphics[width=0.8\textwidth]{spectral_signature_mean_reflectance.png}}\\
\subfloat[]{\includegraphics[width=0.8\textwidth]{spectral_signature_mean_standard_deviation.png}}
