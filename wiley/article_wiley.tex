...
\begin{figure*}[!ht]
\centering
\subfloat[]{\includegraphics[width=5cm]{mean_convergence_3b.png}} 
\subfloat[]{\includegraphics[width=5cm]{mean_convergence_5b.png}}
\subfloat[]{\includegraphics[width=5cm]{mean_convergence_6b.png}}
